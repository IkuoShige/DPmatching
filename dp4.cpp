...
#define DATA_FILE "./output/data_weight_2.txt"
#define SCRIPT_FILE "./output/script_weight_2.gp"
...
void generateScriptFile() {
    ...
    if (scriptFile.is_open()) {
        ...
        scriptFile << "set output \"plot_weight_2.png\"" << endl;
...
int main() {
    ...
    system("gnuplot ./output/script_weight_2.gp");
